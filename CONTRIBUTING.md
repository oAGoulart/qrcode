...
2. Generate _at least_ ten QR codes and try to scan it with your mobile device, try edge cases, like switching subsets, different EC levels, forcing Version (except forcing mask);
